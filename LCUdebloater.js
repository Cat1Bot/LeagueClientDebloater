...
;(function blockApis() {
    ...
    const blockedUrlsRegex = new RegExp(
        blockedUrls
            .map((s) => s.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'))
            .join('|')
    )
...
(function AdminWarn() {
    function initializeObserver() {
        const observer = new MutationObserver(function (
            ...
            const firstGeneralRow = document.querySelector(
                '.lol-settings-general-row, .lol-settings-notifications-row'
            )

            if (
                firstGeneralRow &&
                !document.querySelector('.admin-warning-box')
            ) {
                ...
                adminBox.textContent =
                    'Some of these settings are enforced by League Client Debloater'

                firstGeneralRow.parentNode.insertBefore(
                    adminBox,
                    firstGeneralRow
                )
            }
        ...
        if (document.body) {
            ...
            console.error(
                'Document body is not available for MutationObserver.'
            )
        }
    }
...
(function forceSettings() {
    ...
    const patch = (endpoint, data, schemaVersion = null) => {
    ...
    window.addEventListener(
        ...
        function () {
            ...
            patch('/lol-settings/v2/account/LCUPreferences/lol-general', lcuPreferencesPayload, 1)
            ...
            patch('/lol-settings/v2/local/lol-user-experience', userExperiencePayload, 3)

            const notificationsPayload = {
                disableCollectionsNotifications: true,
                disableEsportsNotifications: true,
            }
            patch('/lol-settings/v2/account/LCUPreferences/lol-notifications', notificationsPayload, 1)
            ...
            patch('/lol-settings/v2/account/LCUPreferences/lol-champ-select', partiesPayload, 0)
        },
        false
    )
})()
...
const UpdateAlert = () => {
    ...
    const shutdown = () =>
        fetch('/process-control/v1/process/quit', { method: 'POST' })
        ...
        if (modifyResponse) {
            ...
            XMLHttpRequest.prototype.open = function (_, url) {
                if (url === '/lol-service-status/v1/ticker-messages') {
                    ...
                    this.send = function (body) {
                        let originalOnReadyStateChanged =
                            this.onreadystatechange

                        this.onreadystatechange = function (ev) {
                            if (this.readyState === 4) {
                                let originalContent = JSON.parse(
                                    this.responseText
                                )
                                ...
                                return originalOnReadyStateChanged.apply(this, [
                                    ev,
                                ])
                            }

                            return originalOnReadyStateChanged.apply(
                                this,
                                arguments
                            )
                        }
...
function P(e, o) {
    ...
    var t = u[e]
    t === void 0
        ? (u[e] = { pre_callback: o, post_callback: void 0 })
        : (u[e].pre_callback = o)
}
function T(e, o) {
    x.trigger()
    var t = u[e]
    t === void 0
        ? (u[e] = { pre_callback: void 0, post_callback: o })
        : (u[e].post_callback = o)
}
function M(e, o) {
    P(e, (t, n, i) => {
        if (typeof n != 'string')
            return (
                console.error(
                    'UPL: Tried to hook text XHR request but body is not a string!'
                ),
                i(n)
            )
        o(n, (r) => {
...
function L(e, o) {
    T(e, (t, n) => {
        if (t.responseType !== '' && t.responseType !== 'text')
            return (
                console.error(
                    'UPL: Tried to hook text XHR request but response is not a string!'
                ),
                n()
            )
        const i = (r) => {
...
function I(e, o) {
    S(e, (t, n) => {
        if (typeof t != 'string')
            return (
                console.error(
                    'UPL: Tried to hook text websocket endpoint but content is not a string!'
                ),
                n(t)
            )
        o(t, (i) => {
...
const R = Object.freeze(
        Object.defineProperty(
            { __proto__: null, hook: S, hookText: I },
            Symbol.toStringTag,
            { value: 'Module' }
        )
    ),
...
const G = Object.freeze(
    ...
    s = Object.freeze(
        Object.defineProperty(
            { __proto__: null, ember: G, ws: R, xhr: D },
            Symbol.toStringTag,
            { value: 'Module' }
        )
    )
function Q(e) {
    if (
        e.rcp === void 0 ||
        typeof e.rcp.preInit != 'function' ||
        typeof e.rcp.postInit != 'function'
    )
